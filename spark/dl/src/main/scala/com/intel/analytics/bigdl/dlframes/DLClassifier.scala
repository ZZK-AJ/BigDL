...
object DLClassifierModel extends MLReadable[DLClassifierModel[_]] {
  ...
  private[dlframes] class DLClassifierModelWriter[@specialized(Float, Double) T: ClassTag](
      instance: DLClassifierModel[T])(implicit ev: TensorNumeric[T])
    extends DLModelWriter[T](instance)
